...
export const networkInfo = new Map<number, NetworkInfo>([
  ...
  [
    11155420,
    {
      ...
      currencySymbol: "ETH",
      baseAPI: "https://transaction-optimism-sepolia.staging.safe.optimism.io/api/v1",
  ...
  [
    424,
    {
      ...
      shortName: "PGN",
      currencySymbol: "ETH",
      baseAPI: "https://transaction-pgn.staging.safe.optimism.io/api/v1",
  ...
  [
    7777777,
    {
      ...
      shortName: "zora",
      currencySymbol: "ETH",
      baseAPI: "https://transaction-zora.staging.safe.optimism.io/api/v1",
  ...
  [
    999999999,
    {
      ...
      currencySymbol: "ETH",
      baseAPI: "https://transaction-zora-sepolia.staging.safe.optimism.io/api/v1",
  ...
  [
    4202,
    {
      ...
      currencySymbol: "ETH",
      baseAPI: "https://transaction-lisk-sepolia.staging.safe.optimism.io/api/v1",
  ...
  [
    1135,
    {
      ...
      shortName: "lisk",
      currencySymbol: "ETH",
      baseAPI: "https://transaction-lisk.staging.safe.optimism.io/api/v1",
  ...
  [
    252,
    {
      ...
      baseAPI: "https://transaction-frax.staging.safe.optimism.io/api/v1",
  ...
  [
    2523,
    {
      ...
      currencySymbol: "frxETH",
      baseAPI: "https://transaction-frax-sepolia.staging.safe.optimism.io/api/v1",
  ...
  [
    17069,
    {
      ...
      currencySymbol: "ETH",
      baseAPI: "https://transaction-redstone-testnet.staging.safe.optimism.io/api/v1",
  ...
  [
    690,
    {
      ...
      shortName: "redstone",
      currencySymbol: "ETH",
      baseAPI: "https://transaction-redstone.staging.safe.optimism.io/api/v1",
  ...
  [
    7560,
    {
      ...
      shortName: "cyber",
      currencySymbol: "ETH",
      baseAPI: "http://transaction-cyber.staging.safe.optimism.io/api/v1",
      stagingBaseAPI: "http://transaction-cyber.staging.safe.optimism.io/api/v1",
    },
  ],
  [
    111557560,
    {
      ...
      currencySymbol: "ETH",
      baseAPI: "http://transaction-cyber-testnet.staging.safe.optimism.io/api/v1",
