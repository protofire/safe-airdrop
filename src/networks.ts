...
export const networkInfo = new Map<number, NetworkInfo>([
  ...
  [
    919,
    {
      ...
      stagingBaseAPI: "https://transaction-mode-sepolia.safe.optimism.io/api/v1",
    },
  ],
  [
    34443,
    {
      ...
      stagingBaseAPI: "https://transaction-mode.safe.optimism.io/api/v1",
    },
  ],
  [
    11155420,
    {
      ...
      stagingBaseAPI: "https://transaction-optimism-sepolia.safe.optimism.io/api/v1",
    },
  ],
  [
    424,
    {
      ...
      stagingBaseAPI: "https://transaction-pgn.safe.optimism.io/api/v1",
    },
  ],
  [
    7777777,
    {
      ...
      stagingBaseAPI: "https://transaction-zora.safe.optimism.io/api/v1",
    },
  ],
  [
    999999999,
    {
      ...
      stagingBaseAPI: "https://transaction-zora-sepolia.safe.optimism.io/api/v1",
    },
  ],
  [
    4202,
    {
      ...
      stagingBaseAPI: "https://transaction-lisk-sepolia.safe.optimism.io/api/v1",
    },
  ],
  [
    1135,
    {
      ...
      stagingBaseAPI: "https://transaction-lisk.safe.optimism.io/api/v1",
    },
  ],
  [
    252,
    {
      ...
      stagingBaseAPI: "https://transaction-frax.safe.optimism.io/api/v1",
    },
  ],
  [
    2523,
    {
      ...
      stagingBaseAPI: "https://transaction-frax-sepolia.safe.optimism.io/api/v1",
    },
  ],
  [
    17069,
    {
      ...
      shortName: "redstone-testnet",
      currencySymbol: "ETH",
      baseAPI: "https://transaction-redstone-testnet.safe.optimism.io/api/v1",
      stagingBaseAPI: "https://transaction-redstone-testnet.safe.optimism.io/api/v1",
    },
  ],
  [
    690,
    {
      ...
      stagingBaseAPI: "https://transaction-redstone.safe.optimism.io/api/v1",
    },
  ],
  [
    7560,
    {
      ...
      shortName: "cyber",
      currencySymbol: "ETH",
      baseAPI: "http://transaction-cyber.safe.optimism.io/api/v1",
      stagingBaseAPI: "http://transaction-cyber.safe.optimism.io/api/v1",
    },
  ],
  [
    111557560,
    {
      chainID: 111557560,
      name: "CyberConnect Testnet",
      shortName: "cyberconnect",
      currencySymbol: "ETH",
      baseAPI: "http://transaction-cyber-testnet.safe.optimism.io/api/v1",
      stagingBaseAPI: "http://transaction-cyber-testnet.safe.optimism.io/api/v1",
    },
  ],
]);
